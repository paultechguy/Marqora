...
public sealed record FormatOptions
{
    ...
    public bool HeadingSpace { get; init; } = true;
    ...
    /// </summary>
    public bool TrailingWhitespace { get; init; } = true;
    ...
    /// </summary>
    public bool NormalizeMarkers { get; init; }
    ...
    /// </summary>
    public bool ReflowParagraphs { get; init; }

    /// <summary>Column to wrap at when <see cref="ReflowParagraphs"/> is on.</summary>
    public int WrapColumn { get; init; } = 80;

    public BulletMarker Bullet { get; init; } = BulletMarker.Dash;

    public EmphasisStyle Emphasis { get; init; } = EmphasisStyle.Asterisk;

    public LineEndingStyle LineEndingStyle { get; init; } = LineEndingStyle.Detect;
