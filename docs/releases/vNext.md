...
losing the paragraph you were reading. The switch now carries the line across in every
direction, including back to split view from preview view, where the preview used to scroll back
up: it stays on what you were reading, and the source scrolls to meet it.
